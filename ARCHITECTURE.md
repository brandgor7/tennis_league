...
player1_is_external  BooleanField    default False; set instead of player1 when that side is a player not registered in the system (no name recorded); mutually exclusive with player1
player2_is_external  BooleanField    default False; set instead of player2 when that side is a player not registered in the system (no name recorded); mutually exclusive with player2
